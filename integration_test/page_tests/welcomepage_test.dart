...
Future<void> main() async {
  ...
  group("Welcomepage testing", () {
    testWidgets('Welcomepage test for login navigation',
        (WidgetTester tester) async {
      await tester.pumpWidget(
          MaterialApp(home: WelcomePage(key: const Key("welcomePage1"))));
    ...
    testWidgets("Welcomepage test for signup navigation",
        (WidgetTester tester) async {
      await tester.pumpWidget(Container());
      await tester.pumpAndSettle();

      await tester.pumpWidget(
          MaterialApp(home: WelcomePage(key: const Key("welcomePage5"))));
